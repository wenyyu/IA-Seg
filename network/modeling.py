...
def _load_model(arch_type, backbone, num_classes, output_stride, dgf, pretrained_backbone):
    ...
    if backbone=='mobilenetv2':
        ...
        model = _segm_resnet(arch_type, backbone, num_classes, output_stride=output_stride, dgf=dgf, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_resnet101(num_classes=21, output_stride=8,dgf=False, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3', 'resnet101', num_classes, output_stride=output_stride, dgf=False, pretrained_backbone=pretrained_backbone)
...
def deeplabv3plus_resnet101(num_classes=21, output_stride=8, dgf=False, pretrained_backbone=False):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'resnet101', num_classes, output_stride=output_stride,dgf=dgf, pretrained_backbone=pretrained_backbone)
